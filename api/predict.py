...
class Predictor:
    def __init__(self,flag = 0,form_data : dict = {}) -> None:
        ...
        self.linear = joblib.load('/Users/igorafanasIev/Desktop/becode_projects/immoeliza_deployment/data/models/linear_regression_model.joblib')
        self.xgboost = xgboost.XGBRegressor()
        self.xgboost.load_model('/Users/igorafanasIev/Desktop/becode_projects/immoeliza_deployment/data/models/Xgbtrained.json')
